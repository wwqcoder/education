...
<div class="article-banner">
    ...
    <div class="banner-info">
        <div class="banner-left">
            ...
            <p class="info">
                <a href="http://ucenter.xuecheng.com:2019/#/learning/${courseBase.id}/0"  target="_blank" v-if="learnstatus == 1" v-cloak>马上学习</a>
	    ...
	    <#if (coursePic.pic)??>
	     <p><img src="http://img.xuecheng.com:2019/${coursePic.pic}" alt="" width="270" height="156"> </p>
	     <#else>
